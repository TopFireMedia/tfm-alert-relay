...
export default async function handler(req, res) {
  ...
  const rowsHtml = rows.map(r => {
    ...
    return `<tr data-host="${esc(host)}" data-status="${st}" data-ver="${esc(r.plugin_version || '')}" data-filter="${filterKey}">
...
<div class="wrap">
  ...
  <div class="card"><div class="table-wrap">
    <table>
      <thead><tr>
        <th>Site</th><th>Domain</th><th>Plugin</th><th>PHP</th><th>WP</th><th>Last seen</th><th>Status</th><th></th>
      </tr></thead>
...
(function(){
  ...
  function recount(){
    ...
    num('stat-ver', Object.keys(vers).length);
